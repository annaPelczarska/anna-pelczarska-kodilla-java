...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryUser libraryUser1 = new LibraryUser("name1","surname1","PESEL1");
        LibraryUser libraryUser2 = new LibraryUser("name2","surname2","PESEL2");
        LibraryUser libraryUser3 = new LibraryUser("name3","surname3","PESEL3");
