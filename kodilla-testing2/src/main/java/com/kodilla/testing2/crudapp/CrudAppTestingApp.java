...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://annapelczarska.github.io/github.io/");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

       WebElement searchTextarea = driver.findElement(By.xpath(XPATH_TEXTAREA));
        searchTextarea.sendKeys("The robotic content");
